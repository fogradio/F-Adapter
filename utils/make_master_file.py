...
DATASET_DICT[name] = {'train_path': '/root/autodl-tmp/data/ns3d_pdb_M1.0_rand/train', 'test_path': '/root/autodl-tmp/data/ns3d_pdb_M1.0_rand/test'}
...
DATASET_DICT[name] = {'train_path': '/root/autodl-tmp/data/ns3d_pdb_M1e-1_rand/train', 'test_path': '/root/autodl-tmp/data/ns3d_pdb_M1e-1_rand/test'}
DATASET_DICT[name]['train_size'] = 90
DATASET_DICT[name]['test_size'] = 10       ### default 200, maximum 1000
DATASET_DICT[name]['scatter_storage'] = True
DATASET_DICT[name]['t_test'] = 11   ## predict 10 timesteps for testing
...
DATASET_DICT[name] = {'train_path': '/root/autodl-tmp/data/ns3d_pdb_M1_turb/train', 'test_path': '/root/autodl-tmp/data/ns3d_pdb_M1_turb/test'}
