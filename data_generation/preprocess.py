...
if __name__ == '__main__':
    ...
    process_pdebench3d_data(path='/root/autodl-tmp/data/3D_CFD_Rand_M1e-1_Eta1e-08_Zeta1e-08_periodic_Train.hdf5',save_name='/root/autodl-tmp/data/ns3d_pdb_M1e-1_rand',n_train=90, n_test=10)
